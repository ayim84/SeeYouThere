...
export default {
    ...
    // yelp: (lat, long) =>
    // {
    //     const client = yelp.client("xPu4PdApD7iZEGV1WZoFEnQ19m1bNtl9UO6chw0e8jkzMb4nnqrS-W3Dsoq6DrnCUhk6acWx-cfV-ZkJmhQ6C02O-7a8PcPL5hHgKP2rG-yshyFN_bNVD-VEyInSW3Yx");
    //     client.search(
    //         {
    //             location: "Denver, CO"
    //         }
